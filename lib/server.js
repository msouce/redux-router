...
exports.reduxReactRouter = undefined;
exports.match = match;
  ...
  return function (options) {
    return function (createStore) {
      return function (reducer, initialState) {
        var store = (0, _redux.compose)((0, _redux.applyMiddleware)((0, _matchMiddleware2.default)(function (url, callback) {
...
var reduxReactRouter = exports.reduxReactRouter = (0, _redux.compose)(serverInvariants, _useDefaults2.default, _routeReplacement2.default, matching)(_reduxReactRouter2.default);